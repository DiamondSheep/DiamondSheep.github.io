...
## Introduction
  ...
  This is a project for the **National Undergraduate Training Program for Innovation and Entrepreneurship**. With a monocular camera (Pi camera V1), a [**Raspberry Pi 3B**](https://www.raspberrypi.com/products/raspberry-pi-3-model-b/) and a roller mechanism, the robot can detect, track and "pick up" the tennis. The project fail in half, since the Raspberry Pi processed the image quite slowly. Unfortunately, this robot was built in 2017 and all of the code was lost.
